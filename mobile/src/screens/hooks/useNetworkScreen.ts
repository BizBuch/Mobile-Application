...
import { Connection } from '../../../../shared/domain/user/entities/Connection';
import { useSendConnectionRequest } from '../../../../shared/application/command/useToggleConnection';
import { useMyConnections } from '../../../../shared/application/query/useConnections';
import { useProfileSuggestions } from '../../../../shared/application/query/useProfileSuggestions';
