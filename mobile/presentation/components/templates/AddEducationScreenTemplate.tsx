...
import { AddEducationFormValues } from '../../../../shared/forms/types/AddEducationForm.types';
...
interface AddEducationScreenTemplateProps {
  // Form props
  control: Control<AddEducationFormValues>;
  errors: FieldErrors<AddEducationFormValues>;
  rules: any;
  ...
  degreeOptions: PickerOption<string>[];
 ...
 * Atomic Design: Template - Layout structure for adding education
 * SOLID Principles:
 * - Single Responsibility: Layout orchestration only
 * - Open/Closed: Content passed via props
 * - Dependency Inversion: Depends on abstractions
 */
export const AddEducationScreenTemplate: React.FC<
  AddEducationScreenTemplateProps
> = ({
  control,
  errors,
  rules,
  ...
  return (
    <SafeAreaView edges={['top']} style={containerStyle}>
      ...
      <View style={headerStyle}>
        ...
        <Text style={headerTitleStyle}>Add Education</Text>
      ...
      <ScrollView contentContainerStyle={scrollContentStyle}>
        {/* School Information */}
        <FormSection title="School Details" showSeparator>
          <Controller
            control={control}
            name="school_name"
        ...
        <FormSection title="Duration" showSeparator>
          ...
          <View style={switchRowStyle}>
            <Text style={switchLabelStyle}>I'm currently studying here</Text>
            <Switch
              value={isCurrent}
